(function () {
  ...
  function mount() {
    ...
    ensureCss("/src/pwa-install-prompt.css?v=20260911pwaFix1", "data-mcj-pwa-install-css");
    ensureScript("/src/pwa-install-prompt.js?v=20260911pwaFix1", "data-mcj-pwa-install-js");
