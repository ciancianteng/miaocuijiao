(function () {
  ...
  function homeDiscordCtaHtml() {
    var ready = !!(
      (window.MCJDiscordCommunity &&
        typeof window.MCJDiscordCommunity.isDiscordInviteReady === "function" &&
        window.MCJDiscordCommunity.isDiscordInviteReady()) ||
      getDiscordInviteUrl()
    );
    return (
      '<div class="mcj-home-discord-cta-wrap">' +
      '<button type="button" class="mcj-home-discord-cta' +
      (ready ? "" : " is-soon") +
      '" data-open-discord aria-label="MEOW CUI JIAO Discord 社区">' +
      ...
      "</span>" +
      '<span class="mcj-home-discord-cta-copy"><strong>MEOW CUI JIAO Discord 社区</strong><span>' +
      (ready ? "加入玩家社区交流" : "正式 Invite 配置后开放") +
      "</span></span>" +
      '<span class="mcj-home-discord-cta-go">' +
      (ready ? "加入 →" : "即将开放") +
      "</span></button></div>"
    );
  }
  function footerHtml() {
    ...
    return (
      homeDiscordCtaHtml() +
      '<footer class="mcj-site-footer" data-mcj-footer>' +
      ...
      '<a class="mcj-footer-link" href="companion-apply.html">申请成为陪玩</a>' +
      '<a class="mcj-footer-link" href="support.html#mcj-discord-community">Discord 社群</a>' +
      '</div></section>' +
      '</div><div class="mcj-footer-bottom"><span>© MEOW CUI JIAO ENTERPRISE. All rights reserved.</span>' +
      ssm +
      "</div></footer>"
    );
  }
  ...
  document.querySelectorAll("[data-mcj-footer], .site-footer, #mcjCoopModal, .mcj-home-discord-cta-wrap").forEach(function (el) { el.remove(); });
    var isHome = /(^|\/)index\.html$|\/$/.test(location.pathname);
