(function(){
  ...
  document.addEventListener('click',function(e){
    ...
    if(confirmAssign){
      ...
      Promise.reject({message:'公开抢单请由老板选择陪玩，客服不可代选'}).then(function(res){
