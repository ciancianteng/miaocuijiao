...
(function () {
  ...
  var GATE_VERSION = "20260830applyClick1";
  ...
  function evaluate() {
    ...
    // —— Companion apply ——
    // Public page. Login is checked on homepage「申请陪玩」click (modal), not on load.
    // Do NOT deny → /login.html here (that bounces to index.html#login and auto-opens modal).
