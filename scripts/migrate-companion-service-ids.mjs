/**
 * Add companion_profiles.service_ids / game_prices and backfill from game names.
 */
...
const SQL_PATH = path.join(ROOT, "supabase", "migrations", "20260731_companion_service_ids.sql");
...
async function main() {
  ...
  try {
    ...
    const sample = await client.query(`
      select nickname, service_type, game, service_ids, game_prices
