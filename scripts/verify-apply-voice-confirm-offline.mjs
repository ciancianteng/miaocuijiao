...
const checks = [
  ...
  ["too_short phase", t.includes("TOO_SHORT") && t.includes("不足10秒")],
  ["exact min tip", t.includes("语音介绍至少需要录制 10 秒")],
  ...
  ["analyze timeout", t.includes("withTimeout") && t.includes("analyzeVoiceBlob")],
  ["stop watchdog", t.includes("stopWatchdogTimer")],
