(function () {
  ...
  function bindQuickEntries() {
    document.addEventListener("click", function (event) {
      ...
      if (team) {
        ...
        location.href = link || "/team-lobby.html";
      }
    }, true);
  }
  ...
  function fixVoiceHall() {
    // Mobile bottom nav no longer routes to ?service=voice / 「语音大厅」.
    // Keep as no-op so legacy bookmarks do not retitle the companion hall.
    return;
  }
